...
public class ImprovedArmorUpgrade : CardUpgrade
{
    private const float ArmorAdditiveBonus = 35f;

    public override UpgradeType Type => UpgradeType.ImprovedArmor;
    public override string Title => "Improved Armor";
    public override string Description => $"+{ArmorAdditiveBonus:0} armor.";
    ...
    public override Action<ulong, ECS> OnSpawnAtPointCardPlayed => (entityId, ecs) =>
    {
        ...
        {
            ArmorAdditiveBonus = ArmorAdditiveBonus,
        });
    };
}
