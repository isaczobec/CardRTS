public class TroopDiedEvent : FlagEvent
{
    public ulong EntityId { get; set; }

    // Captured by DeathRequest at the moment this was raised — see PositionQuery.TryGet.
    // Must be captured then, not resolved later: DeathRequest deletes the entity (and its
    // PositionComponent with it) later the very same tick.
